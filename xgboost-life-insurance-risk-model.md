...
1. __Web Form Application:__ ([how to make a Chalice Webapp that calls a model Endpoint](https://github.com/ELEai/tutorials/blob/master/serverless_chalice.md)) 
